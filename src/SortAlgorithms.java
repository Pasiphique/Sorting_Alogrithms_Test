...
// Median of three QUICK SORT
     ...
     * @param first the integer index of the first array element; first >= 0 and
     * < a.length @par
     * am mid the integer index of the middle array element
     ...
     *
     *
     * aram a an array of Comparable objects
    ...
    public static <T extends Comparable<? super T>>
        ...
        getNumber(array, 0, n - 1);
        RandomquickSort(array, 0, n - 1);
    } // end quickSort

    public static <T extends Comparable<? super T>>
            void RandomquickSort(T[] array, int first, int last) {
        if (last - first + 1 < MIN_SIZE) {
            insertionSort(array, first, last);
        } else {
            // create the partition: Smaller | Pivot | Larger
            ...
            // sort subarrays Smaller and Larger
            RandomquickSort(array, first, pivotIndex - 1);
            RandomquickSort(array, pivotIndex + 1, last);
        } // end if
    }  // end quickSort
